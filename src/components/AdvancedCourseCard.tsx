...
const AdvancedCourseCard: React.FC<AdvancedCourseCardProps> = ({
    id,
    title,
    description,
    learners,
    ...
    return (
        <Link
            href={`/demo/course/${id}`}
            className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden p-2 flex flex-col w-full max-w-[350px] transition-all hover:shadow-md hover:border-green-200 active:scale-[0.99] group"
        >
